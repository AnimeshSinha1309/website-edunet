...
<body> <div align="center" class="margin_body">
	<div>
    ...
    <div id="signup_about">
        <div class="text header_subtitle aboutus_header">
            What is Edunet?
        </div>
        <div class="text aboutus_header">
        ...
        <div class="youtube_video">
            <iframe align="left" width="569" height="340" src="//www.youtube.com/embed/r1qtaEB9vL4" frameborder="0" allowfullscreen></iframe>
        </div>
        ...
        <div class="youtube_video">
            <iframe align="left" width="569" height="340" src="//www.youtube.com/embed/3f0tMs1mT24" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    <div id="signup" align="center">
    <div id="signup_box" align="center">
     	<br/> <br/>
        ...
        <form method="post" action="register.php">
			...
			<input align="middle" class="form_text recover_contraction" name="FirstName" type="text" placeholder="First" spellcheck="false">
			<input align="middle" class="form_text recover_contraction" name="LastName" type="text" placeholder="Last" spellcheck="false">
			<br/> <label class="text"> <strong> Google Account </strong> </label>
			<input align="middle" class="form_text recover_contraction" name="GoogleAcc" type="email" placeholder="eg. AnimeshSinha1309@gmail.com" spellcheck="false">
			<br/> <label class="text"> <strong> Password </strong> </label>
			<input align="middle" class="form_text recover_contraction" name="Password" type="password" placeholder="Password" spellcheck="false">
			<br/> <label class="text"> <strong> Confirm Password </strong> </label>
			<input align="middle" class="form_text recover_contraction" name="Conformation" type="password" placeholder="Password" spellcheck="false">
			<br/> <label class="text"> <strong> Edunet Username </strong> (For future use only) </label>
			<input align="middle" class="form_text recover_contraction" name="Username" type="text" placeholder="eg. AnimeshSinha" spellcheck="false">
			<br/> <label class="text"> <strong> Date of Birth </strong> </label>
			<label  id="register_birthday_date"> <input align="middle" maxlegth="2" class="form_text recover_contraction" placeholder="Date" name="BirthDate" type="text" spellcheck="false">
            <select name="BirthMonth" id="register_birthday_month">
			...
			<input align="middle" maxlegth="4" class="form_text recover_contraction" placeholder="Year" name="BirthYear" type="text" spellcheck="false">
			<br/> <label class="text text_small"> <strong> Account Type </strong> </label> <br/>
			<blockquote>
			    <input align="middle" class="" name="Account" type="radio" value="Student"> <label class="text"> Student </label> </input> <br/>
			    <input align="middle" class="" name="Account" type="radio" value="Coach"> <label class="text"> Coach </label> </input> <br/>
			    <input align="middle" class="" name="Account" type="radio" value="Developer"> <label class="text"> Developer </label> </input> <br/>
            </blockquote>
			<br/> <label class="text text_small"> <strong> School </strong> </label>
			<input align="middle" class="form_text recover_contraction" name="School" type="text" placeholder="eg. St. Thomas" spellcheck="false">
			<br/> <label class="text text_small"> <strong> Grade / Standard </strong> </label>
			<input align="middle" class="form_text recover_contraction" name="Grade" type="text" placeholder="eg. Std. 9 or M.Tech" spellcheck="false">
            <br/>
			<input align="middle" type="submit" class="form_submit recover_contraction" value="Register">
        </form>
        <br/>
        <div class="text">
