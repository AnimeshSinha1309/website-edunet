...
<head>
    ...
    <?php if(isset($script)): ?><script src="<?php echo("/javascript/".$script.".js"); ?>" type="text/javascript"></script><?php endif ?>
</head>
<body>
<header>
    <div>
            ...
            <section class="top-bar-section">
                <ul class="right">
                    ...
                    <li class="has-dropdown not-click">
                        ...
                        <ul class="dropdown">
                            <?php if($dev){ ?>
                                <li <?php if($navpos === "dashboard")echo("class=\"active\""); ?>><a href="/index.php?tab=tasks">Dashboard</a></li>
                                <li <?php if($navpos === "profile")echo("class=\"active\""); ?>><a href="/index.php?tab=profile">Profile</a></li>
                            <?php } ?>
                ...
                <ul class="left">
                    ...
                    <li class="has-dropdown not-click">
                        ...
                        <ul class="dropdown">
                            ...
                            <li <?php if($navpos === "represent")echo("class=\"active\""); ?>><a href="/public/represent.php">Represent</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                </ul>
